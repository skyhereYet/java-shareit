...
public class ItemRequestController {
    ...
    @GetMapping
    public List<ItemRequestInfo> getAllByUserId(@RequestHeader("X-Sharer-User-Id") int userId) {
        log.info("GET request. Get all requests by user ID - " + userId);
        return itemRequestService.getAllRequest(userId);
    }

    @GetMapping("/all")
    public List<ItemRequestInfo> getAllPagination(@RequestHeader("X-Sharer-User-Id") int userId,
    ...
    public ItemRequestInfo getItemRequestById(@RequestHeader("X-Sharer-User-Id") int userId,
