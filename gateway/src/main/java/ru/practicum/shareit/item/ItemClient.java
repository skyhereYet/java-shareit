...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> updateItem(int itemId, long userId, ItemDto itemDto) {
    ...
    public ResponseEntity<Object> getItemsBySubstring(String text, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
